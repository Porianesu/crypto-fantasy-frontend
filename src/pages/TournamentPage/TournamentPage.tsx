...
const fetchPrizePools = async () => {
  return new Promise((resolve) => {
    ...
    resolve([
      {
        id: 0,
        start_date: today.subtract(9, 'day'),
        end_date: today.subtract(7, 'day').endOf('day'),
      ...
      },
      {
        ...
        end_date: today.subtract(4, 'day').endOf('day'),
        price: getRandomPrice(),
        status: PRIZE_POOL_STATUS.END,
      },
      {
        id: 2,
        start_date: today.subtract(3, 'day'),
        end_date: today.subtract(1, 'day').endOf('day'),
        price: getRandomPrice(),
        status: PRIZE_POOL_STATUS.END,
      },
      {
        id: 3,
        start_date: today,
        end_date: today.add(2, 'day').endOf('day'),
        price: getRandomPrice(),
        status: PRIZE_POOL_STATUS.PROCESSING,
      },
      {
        id: 4,
        start_date: today.add(3, 'day'),
        end_date: today.add(5, 'day').endOf('day'),
        price: getRandomPrice(),
